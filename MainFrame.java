...
public class MainFrame extends JFrame {
     ...
     * @param listen listener to connect.
     */
    public void addToolNameListener(ActionListener listen){ toolNameButton.addActionListener(listen);
}
    /**
    ...
    public void addOrderListener(ActionListener listen){ printOrderButton.addActionListener(listen);
    }
